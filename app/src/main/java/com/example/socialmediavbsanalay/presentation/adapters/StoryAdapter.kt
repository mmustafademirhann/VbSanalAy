...
class StoryAdapter @Inject constructor() : RecyclerView.Adapter<StoryAdapter.StoryViewHolder>() {
    ...
    fun loadStories(): List<Story> {
        return listOf(
            ...
            Story(imageResId = R.drawable.bra, username = "user2"),
            Story(imageResId = R.drawable.family, username = "user3"),
            Story(imageResId = R.drawable.rainy_minecraft, username = "user4"),
            Story(imageResId = R.drawable.addstory, username = "user5"),
            Story(imageResId = R.drawable.homeicon, username = "user1"),
            Story(imageResId = R.drawable.ekle, username = "user2"),
            Story(imageResId = R.drawable.email, username = "user3"),
            Story(imageResId = R.drawable.homeicon, username = "user4"),
            Story(imageResId = R.drawable.aysegulmustafa, username = "user5"),
            Story(imageResId = R.drawable.aysegulmustafa, username = "user1"),
            ...
            Story(imageResId = R.drawable.aysegulmustafa, username = "user1"),
            Story(imageResId = R.drawable.shin, username = "user2"),
            Story(imageResId = R.drawable.sendicon, username = "user3"),
            Story(imageResId = R.drawable.shin, username = "user4"),
            Story(imageResId = R.drawable.rednotification, username = "user5"),
            Story(imageResId = R.drawable.aysegulmustafa, username = "user1"),
            Story(imageResId = R.drawable.bra, username = "user2"),
            Story(imageResId = R.drawable.family, username = "user3"),
            Story(imageResId = R.drawable.rainy_minecraft, username = "user4"),
